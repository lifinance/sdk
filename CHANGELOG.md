...
> **Archived.** This root changelog records the lerna + standard-version era up to
> `4.0.0-beta.11`. From the Changesets cutover onward, release notes are tracked
> **per package** in `packages/*/CHANGELOG.md` (generated by Changesets). New entries
> are no longer appended here; this file is preserved as the historical v3/early-v4
> audit trail.
