...
/** Standard execution: approval via on-chain tx or native permit, then wait for confirmation. */
export class EthereumCheckAllowanceStandardTask extends BaseStepExecutionTask<
  EthereumTaskExtra,
  void
> {
  readonly type = 'ETHEREUM_CHECK_ALLOWANCE_STANDARD'
