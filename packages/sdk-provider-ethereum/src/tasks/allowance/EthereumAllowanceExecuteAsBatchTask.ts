...
/** Allowance sub-task (batch): build approval calls for EIP-5792 sendCalls, set BATCH_APPROVAL. */
export class EthereumAllowanceExecuteAsBatchTask extends BaseStepExecutionTask<
  EthereumTaskExtra,
  { allowanceFlow: AllowanceFlowState }
> {
  readonly type = 'ETHEREUM_ALLOWANCE_EXECUTE_AS_BATCH'
