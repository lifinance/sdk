...
/** Allowance sub-task: run checkPermits for step.typedData permits. Short-circuits if result. */
export class EthereumAllowanceRunPermitsTask extends BaseStepExecutionTask<
  EthereumTaskExtra,
  { allowanceFlow: AllowanceFlowState }
> {
  readonly type = 'ETHEREUM_ALLOWANCE_RUN_PERMITS'
