...
export const permit2ProxyAbi: Abi = parseAbi([
...
export const eip2612Abi: Abi = parseAbi([
...
export const approveAbi: Abi = parseAbi([
  'function approve(address, uint256) external returns (bool)',
])

export const allowanceAbi: Abi = parseAbi([
  'function allowance(address, address) external view returns (uint256)',
])

export const getEthBalanceAbi: Abi = parseAbi([
  'function getEthBalance(address) external view returns (uint256)',
])

export const balanceOfAbi: Abi = parseAbi([
