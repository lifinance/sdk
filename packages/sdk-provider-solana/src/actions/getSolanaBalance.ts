  ...
  const [slot, balance, tokenAccountsByOwner, token2022AccountsByOwner] =
    await Promise.allSettled([
      ...
      withDedupe(
        ...
        {
          id: `${getSolanaBalanceDefault.name}.getTokenAccountsByOwner.${TokenProgramId}.${walletAddress}`,
        }
      ),
      withDedupe(
        () =>
        ...
        {
          id: `${getSolanaBalanceDefault.name}.getTokenAccountsByOwner.${Token2022ProgramId}.${walletAddress}`,
        }
      ),
    ])
