...
> Many entries reference packages other than `@lifi/sdk`; per-package release
> notes (attributed by Changesets) appear above this section as future releases
> ship.

All notable changes to this project (through the standard-version era) are documented in this file. See [standard-version](https://github.com/conventional-changelog/standard-version) for commit guidelines.
