...
async function getAndTestTransaction(
  ...
  const parsed = paraswap.parseReceipt(tx, receipt)
    ...
    describe('BSC', () => {
      ...
      it('token to gas', async () => {
        ...
        const expected = {
          ...
          toAmount: '0', // FIXME: find out how to get real value
          gasUsed: '180952',
          gasPrice: '5000000000',
    ...
    describe('AVA', () => {
      ...
      it('token to gas', async () => {
        ...
        const expected = {
          ...
          toAmount: '0', // FIXME: find out how to get real value > '9609034319672914'
          gasUsed: '230587',
